...
Die Voraussaat steht dort, bis der Boden für die dort vorgesehenen Kulturen benötigt wird \cite[S.~37f]{Franck1981}.
...
Der Same sollte breitwürfig ausgebracht und ggf. vor Vogelfraß mit einem Vlies oder Netz geschützt werden \cite[S.~11]{Heberer2018}.

Laut Franck \cite[S.~37ff]{Franck1981} eignen sich als Voraussaat Senf, Ackerbohne, Kresse (nur für Tomaten) und Phacelia, nach Schwinn \cite{Schwinn2025} auch Lupine.
...
Im Widerspruch dazu steht die Aussage von Heberer \cite[S.~115]{Heberer2018}, dass die nahe Verwandtschaft des Gelbsenfs mit den Gemüsearten der Kohlgewächse (Brassicaceae), wie z.B. Kohl, Radieschen, Kohlrabi, Rettich oder Kresse, dazu führen kann, ``dass sich Krankheiten und Schädlinge (allen voran die gefürchtete Kohlhernie) im Garten ausbreiten'' \cite[S.~115]{Heberer2018}.
...
Wurde Phacelia schon vor dem Winter als nicht winterharte Gründüngung ausgebracht, können die Pflanzenrückstände im Frühjahr entweder als Mulchschicht auf der Bodenoberfläche verbleiben, oder sie werden flach eingearbeitet, damit sie sich komplett zersetzen und die noch enthaltenen Nährstoffe freisetzen \cite[S.~11]{Heberer2018}.
...
\paragraph{Lupine}
Nach Schwinn \cite{Schwinn2025} ist auch die Lupine ein Stickstoffsammler, d.h. sie hat die selben Qualitäten wie die Ackerbohne---siehe oben.
...
Heberer \cite[S.~114]{Heberer2018} listet einige weitere Pflanzenarten zusätzlich zu den o.g. auf.

\pagebreak

\chapter{Strauchbeerenobst}
